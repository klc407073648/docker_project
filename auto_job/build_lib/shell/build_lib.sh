...
function printEnvInfo() 
{
  ...
  logInfo "container_name:[${build_lib_container_name}]"
  logInfo "image_name:[${build_lib_image_name}]"
  logInfo "code_download_path:[${build_lib_code_download_path}]"
  logInfo "code_git_name:[${build_lib_code_git_name}]"
  logInfo "code_git_path:[${build_lib_code_git_path}]"
